...
┛┗┗┛┛┗┗┻┛┗ 
		version: ` + version + `
`
	fmt.Println(gradient(banner, pink))
}
...
func Flag(Info *HostInfo) {
	...
	flag.BoolVar(&AdaptiveLearning, "AL", false, "Adaptive Learning")
	flag.BoolVar(&ReinforcementLearning, "RL", false, "Reinforcement Learning")
	flag.Parse()
}
